package com.lingyu.lingyuappcraft.core;
...
import com.lingyu.lingyuappcraft.core.parser.CodeParserExecutor;
import com.lingyu.lingyuappcraft.core.saver.CodeFileSaverExecutor;
...
public class AiCodeGeneratorFacade {
    ...
    public File generateAndSaveCode(String userMessage, CodeGenTypeEnum codeGenTypeEnum, Long appId) {
        ...
        return switch (codeGenTypeEnum) {
            case HTML -> {
                HtmlCodeResult result = aiCodeGeneratorService.generateHtmlCode(appId.intValue(), userMessage);
